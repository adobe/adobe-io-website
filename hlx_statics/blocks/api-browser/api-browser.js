      ...
      buttons.forEach((b) => {
        if (card[b] !== '') {
          ...
          if (b === 'Learn More') {
            ...
            buttonTemplate
              += `<a href="${link}" class="spectrum-Button spectrum-Button--outline spectrum-Button--secondary spectrum-Button--quiet spectrum-Button--sizeM" id="${(card.Title).replace(/\s/g, '')}-lm" aria-labelledby="${(card.Title).replace(/\s/g, '')}-lm ${(card.Title).replace(/\s/g, '')}">
            ...
            buttonTemplate
              += `
                <a href="${link}" class="spectrum-Button spectrum-Button--outline spectrum-Button--accent spectrum-Button--sizeM" id="${(card.Title).replace(/\s/g, '')}-vd" aria-labelledby="${(card.Title).replace(/\s/g, '')}-vd ${(card.Title).replace(/\s/g, '')}">
                  <span class="spectrum-Button-label">${b}</span>
                </a>
              `;
          }
