...
window.adobeid = {"client_id": "helix_adobeio","scope": "AdobeID,openid,unified_dev_portal,read_organizations,additional_info.projectedProductContext,additional_info.roles,gnav,read_pc.dma_bullseye,creative_sdk", "locale": "en_US", "environment": "stg1", "useLocalStorage": false, "logsEnabled": true, redirect_uri: window.location.href};
adobeIMSMethods = {
  signIn: function () {
      adobeIMS.signIn();
  },
